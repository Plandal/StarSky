...
public class HardCodedParameters {
    ...
    public static final int defaultWidth = 1900, defaultHeight = 1000,
            heroesStartX = 80, heroesStartY = 200, heroesWidth=60, heroesHeight=30, heroesStep = 10, heroesLife = 100, heroesArmor=20,
            phantomWidth = 30, phantomHeight = 30, phantomStep = 10,
            enemyWidth = 30, enemyHeight = 30, enemyStep = 10;
    public static final String weaponShotGunName = "ARMS",weaponGrenadeName = "BOMB";
    public static final double weaponShotGunFireRate = 150, weaponShotGunFireSpeed = 50, weaponGrenadeFireRate=1, weaponGrenadeFireSpeed = 5;
    public static final int weaponShotGunHitDommage = 20, weaponGrenadeHitDommage=50,
            weaponShotGunAmmo = 999999, weaponGrenadeAmmo=3;
    public static final int enginePaceMillis = 20,
            spriteSlowDownRate = 7;



    public static final Media musikShoot = new Media(Paths.get("src/sound/laser.wav").toUri().toString());
